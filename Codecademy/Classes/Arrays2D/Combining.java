...
public class Combining {
    public static void main(String[] args) {
        ...
        //Declare and initialize a new 2D array of integers with 4 rows and 6 columns called `newImage`.
        int[][] newImage = new int[4][6];



        //Now that you have your empty image, use nested **for** loops to copy over the data from the
        //original image to the new image, make sure not to include the cropped out columns.
