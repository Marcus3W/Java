...
public class MainMenu extends JFrame implements Runnable {
    ...
    public MainMenu() {
        ...
        this.startGame = new Text("Start Game",
                new Font("Time New Roman", Font.PLAIN, 40), Constants.SCREEN_WIDTH / 2.0 - 140.00, Constants.SCREEN_HEIGHT / 2.0, Color.WHITE);
        this.exitGame = new Text("Exit",
                new Font("Time New Roman", Font.PLAIN, 40), Constants.SCREEN_WIDTH / 2.0 - 80.00, Constants.SCREEN_HEIGHT / 2.0 + 60, Color.WHITE);
        this.pong = new Text("Pong",
                new Font("Time New Roman", Font.PLAIN, 100), Constants.SCREEN_WIDTH / 2.0 - 155.0, 200, Color.WHITE);
